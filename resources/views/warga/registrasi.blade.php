            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        <label for="nik">Masukkan username yang telah disalin</label>
                        <input type="text" class="form-control" name="nik" id="nik"
                            placeholder="Masukkan Username" required>
                    </div>
                    <div class="text-center">
                        <button type="button" class="btn btn-primary btnLogin">Lanjutkan</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            $('.btnLogin').on('click', function(a) {
                ...
                axios.post('/registrasi/check', {
                    ...
                    if (response.data.success) {
                        window.location.href = `/registrasi/daftar/${response.data.nik}`;
                    } else {
                        swal.fire({
